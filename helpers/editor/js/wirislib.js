...
function updateHTMLCode(){
	...
	// var htmlcodeIinput = document.getElementById("htmlcodeIinput");
	...
	// htmlcode_div.value = htmlcode_div.value = "<pre class='wrs_inline'><code id='code_block' style='color:#e0e0e0'>" + data_code + "</code></pre>";
	htmlcode_div.value = htmlcode_div.value = data_code;
	// htmlcodeIinput.value = data_code;
	highlightCode(data);
}
